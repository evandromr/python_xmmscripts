...
cleanevt = "m1_clean.ds"
cleanrate = "m1_rate_clean.ds"
cleanimg = "m1_image_clean.ds"
...
subprocess.call(['evselect', 'table={0}:EVENTS'.format(m1events),
...
subprocess.call(['evselect', 'table={0}'.format(m1events), 'withimageset=true',
